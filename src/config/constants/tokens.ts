...
export const MTW: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0x8Fb7a3d213C3a2B605386cd3617fE0eaaB7F3b1c',
    18,
    'MTW',
    'MetaWorth',
  ),
...
const tokens = {
  ...
  mtw:{
    symbol: 'MTW',
    address: {
      56: '0x8Fb7a3d213C3a2B605386cd3617fE0eaaB7F3b1c', /* 0x504BA9B11c727688cCca62BAE112C2c62085129E */
      97: ''
    },
    decimals: 18,
    projectLink: 'http://mtw.finance/',
  },
  xbpt:{
    symbol: 'xBPT',
    address: {
    ...
    decimals: 18,
    projectLink: 'https://dex.metaworth.exchange/',
  },
  mtkey:{
    symbol: 'MetaKey',
    address: {
      56: '0xD57d78c6d32D5207fF8C6CF18a8Cea19Fd36b994',
      97: ''
    },
    decimals: 18,
    projectLink: 'https://dex.metaworth.exchange/',
