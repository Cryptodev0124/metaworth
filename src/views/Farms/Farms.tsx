...
const Farms: React.FC<FarmsProps> = (farmsProps) => {
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { cakeRewardsApr, lpRewardsApr } = isActive
          ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET], new BigNumber(farm.mtwPerBlock))
  ...
  return (
    <>
      <img src='./images/title-bg.png' alt='title' style={{marginLeft: "0%"}} width="100%"/>
      <Page>
        <ControlContainer>
          <ViewControls>
