    ...
    switch (step) {
      ...
      case 0:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get MTW-BNB LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake MTW and BNB in the liquidity pool to get LP tokens.')} <br />
      ...
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the LAUNCHPAD sales finish, you can claim any LAUNCHPAD tokens that you bought, and any unspent MTW-BNB LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
