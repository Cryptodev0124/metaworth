...
const ActionPanel: React.FC<ActionPanelProps> = ({ account, pool, userDataLoaded, expanded, breakpoints }) => {
  ...
  const depositTime = userData?.depositTime ? new BigNumber(userData.depositTime) : BIG_ZERO
  const timeleft = +depositTime.toNumber() + +interval - +currentTime
      ...
      <Flex mb="8px" justifyContent="space-between">
        ...
        <Flex>
          <Link external href={getBscScanLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
            <Balance fontSize="16px" value={depositTime.toNumber() !== 0 ? timeleft > 0 ? timeleft / 86400 : -(timeleft) / 86400 : 0} decimals={1} color="primary" />
            <Text ml="4px" color="primary" textTransform="lowercase">
              {/* {t('Days left')} */}
              {depositTime.toNumber() !== 0 ? timeleft > 0 ? t('Days left') : t('Days past') : t('Waiting')}
            </Text>
